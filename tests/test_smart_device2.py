...
def mockSmartDevice2():
    ...
    dev = SmartDevice2(
        device, "mock NZXT Smart Device V2", speed_channel_count=3, color_channel_count=2
    )
    dev.connect()
    return dev
...
def test_smart_device2_not_totally_broken(mockSmartDevice2):
    ...
    dev.set_color(channel="led1", mode="breathing", colors=iter([[142, 24, 68]]), speed="fastest")
