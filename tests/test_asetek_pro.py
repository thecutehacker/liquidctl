...
def test_not_totally_broken(emulate):
    ...
    with cooler.connect():
        ...
        cooler.set_speed_profile(channel="fan", profile=iter([(20, 20), (30, 50), (40, 100)]))
        cooler.set_speed_profile(channel="fan1", profile=iter([(20, 20), (30, 50), (40, 100)]))
...
def test_set_pump_to_fixed_color(emulate):
    ...
    with cooler.connect():
        ...
        assert color_change == ("write", 1, [0x56, 0x02, 0xFF, 0x88, 0x44, 0xFF, 0x88, 0x44])
...
def test_set_pump_to_blinking_mode(emulate):
    ...
    with cooler.connect():
        ...
        assert color_change == (
            "write",
            1,
            [0x56, 0x03, 0xFF, 0x88, 0x44, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00],
        )
